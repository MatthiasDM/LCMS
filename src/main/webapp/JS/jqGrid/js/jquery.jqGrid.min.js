...
Ca="",Da="Bootstrap"===e.p.styleUI?2:0;ba(),$(x).css("width",f.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+e.p.id+"'>&#160;</div>"),e.p.scrollPopUp&&$(x).append("<div "+l(m,"scrollBox",!1,"loading ui-scroll-popup")+" id='scroll_g"+e.p.id+"'></div>"),$(k).css("width",f.width+"px"),ua=$("thead:first",e).get(0),e.p.footerrow&&(Ca+="<table role='presentation' style='width:"+e.p.tblwidth+"px' "+l(m,"footerTable",!1,"ui-jqgrid-ftable ui-common-table")+"><tbody><tr role='row' "+l(m,"footerBox",!1,"footrow footrow-"+i)+">");var
...
e.p.pager?"#"!==e.p.pager.substr(0,1)&&(e.p.pager="#"+e.p.pager):e.p.pager="#"+$(e.p.pager).attr("id"),$(e.p.pager).css({width:f.width+"px"}).addClass(l(m,"pagerBox",!0,"ui-jqgrid-pager")).appendTo(x),Ha&&$(e.p.pager).hide(),Z(e.p.pager,"")),!1===e.p.cellEdit&&!0===e.p.hoverrows&&$(e).on({mouseover:function(a){qa=$(a.target).closest("tr.jqgrow"),"ui-subgrid"!==$(qa).attr("class")&&$(qa).addClass(p)},mouseout:function(a){qa=$(a.target).closest("tr.jqgrow"),$(qa).removeClass(p)}});var
...
Pa=$(".ui-jqgrid-view").css("font-size")||"11px",Qa='<ul id="'+e.p.id+'_menubar" class="ui-search-menu modal-content column-menu ui-menu '+s.menu_widget+'" role="menubar" tabindex="0" style="left:5px;top:25px;position:absolute;display:none;font-size:'+Pa+'"></ul>';$("body").append(Qa),$(f.cDiv).append("<a role='link' class='ui-jqgrid-menubar menubar-"+("rtl"===i?"rtl":"ltr")+"' style=''><span class='colmenuspan "+r+" "+s.icon_toolbar_menu+"'></span></a>"),$(".ui-jqgrid-menubar",f.cDiv).hover(function(){$(this).addClass(p)},function(){$(this).removeClass(p)}).on("click",function(a){var
b=$(a.target).offset();$("#"+e.p.id+"_menubar").css({left:b.left-("rtl"===i?$("#"+e.p.id+"_menubar").width():0),top:b.top+20}).show()})}if($(f.cDiv).insertBefore(f.hDiv),e.p.toolbar[0]){var
Ra=l(m,"customtoolbarBox",!0,"ui-userdata");f.uDiv=document.createElement("div"),"top"===e.p.toolbar[1]?$(f.uDiv).insertBefore(f.hDiv):"bottom"===e.p.toolbar[1]&&$(f.uDiv).insertAfter(f.hDiv),"both"===e.p.toolbar[1]?(f.ubDiv=document.createElement("div"),$(f.uDiv).addClass(Ra+" ui-userdata-top").attr("id","t_"+this.id).insertBefore(f.hDiv).width(f.width-Da),$(f.ubDiv).addClass(Ra+" ui-userdata-bottom").attr("id","tb_"+this.id).insertAfter(f.hDiv).width(f.width-Da),Ha&&$(f.ubDiv).hide()):$(f.uDiv).width(f.width-Da).addClass(Ra+" ui-userdata-top").attr("id","t_"+this.id),Ha&&$(f.uDiv).hide()}if(e.p.toppager&&(e.p.toppager=$.jgrid.jqID(e.p.id)+"_toppager",f.topDiv=$("<div id='"+e.p.toppager+"'></div>")[0],e.p.toppager="#"+e.p.toppager,$(f.topDiv).addClass(l(m,"toppagerBox",!0,"ui-jqgrid-toppager")).width(f.width-Da).insertBefore(f.hDiv),Z(e.p.toppager,"_t")),e.p.footerrow&&(f.sDiv=$("<div class='ui-jqgrid-sdiv'></div>")[0],Ia=$("<div class='ui-jqgrid-hbox"+("rtl"===i?"-rtl":"")+"'></div>"),$(f.sDiv).append(Ia).width(f.width-Da).insertAfter(f.hDiv),$(Ia).append(Ca),f.footers=$(".ui-jqgrid-ftable",f.sDiv)[0].rows[0].cells,e.p.rownumbers&&(f.footers[0].className=l(m,"rownumBox",!0,"jqgrid-rownum")),Ha&&$(f.sDiv).hide()),Ia=null,e.p.caption){var
Sa=e.p.datatype;!0===e.p.hidegrid&&($(".ui-jqgrid-titlebar-close",f.cDiv).click(function(a){var
b,c=$.isFunction(e.p.onHeaderClick),d=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-toppager, .ui-jqgrid-pager, .ui-jqgrid-sdiv",g=this;return!0===e.p.toolbar[0]&&("both"===e.p.toolbar[1]&&(d+=", #"+$(f.ubDiv).attr("id")),d+=", #"+$(f.uDiv).attr("id")),b=$(d,"#gview_"+$.jgrid.jqID(e.p.id)).length,"visible"===e.p.gridstate?$(d,"#gbox_"+$.jgrid.jqID(e.p.id)).slideUp("fast",function(){0===--b&&($("span",g).removeClass(Ma).addClass(Na),e.p.gridstate="hidden",$("#gbox_"+$.jgrid.jqID(e.p.id)).hasClass("ui-resizable")&&$(".ui-resizable-handle","#gbox_"+$.jgrid.jqID(e.p.id)).hide(),$(e).triggerHandler("jqGridHeaderClick",[e.p.gridstate,a]),c&&(Ha||e.p.onHeaderClick.call(e,e.p.gridstate,a)))}):"hidden"===e.p.gridstate&&$(d,"#gbox_"+$.jgrid.jqID(e.p.id)).slideDown("fast",function(){0===--b&&($("span",g).removeClass(Na).addClass(Ma),Ha&&(e.p.datatype=Sa,X(),Ha=!1),e.p.gridstate="visible",$("#gbox_"+$.jgrid.jqID(e.p.id)).hasClass("ui-resizable")&&$(".ui-resizable-handle","#gbox_"+$.jgrid.jqID(e.p.id)).show(),$(e).triggerHandler("jqGridHeaderClick",[e.p.gridstate,a]),c&&(Ha||e.p.onHeaderClick.call(e,e.p.gridstate,a)))}),!1}),Ha&&(e.p.datatype="local",$(".ui-jqgrid-titlebar-close",f.cDiv).trigger("click")))}else
...
a=this,b=a.p.colModel,c=0,d=b.length,e=-1,f=!1,g=$(a).jqGrid("getStyleUI",a.p.styleUI+".base","headerDiv",!0,"ui-jqgrid-hdiv"),h=$(a).jqGrid("getStyleUI",a.p.styleUI+".common","hover",!0),i="border-box"===$("#gbox_"+$.jgrid.jqID(a.p.id)).css("box-sizing"),j=i?1:0;if(!0!==a.p.subGrid&&!0!==a.p.treeGrid&&!0!==a.p.cellEdit&&!a.p.scroll&&!0!==a.p.grouping){for(;c<d&&!0===b[c].frozen;)f=!0,e=c,c++;if(e>=0&&f){var
...
X;if(F?(a(L).find("#pData").replaceWith(P),a(L).find("#nData").replaceWith(Q),a(L).find("#sData").replaceWith(R),a(L).find("#cData").replaceWith(S),X=a("<div id="+z+"></div>").append(L)):X=a("<div></div>").append(L).append(U),a(L).append("<div class='binfo topinfo bottominfo'>"+b[s.p.id].bottominfo+"</div>"),a.jgrid.createModal(B,X,b[a(this)[0].p.id],"#gview_"+a.jgrid.jqID(s.p.id),a("#gbox_"+a.jgrid.jqID(s.p.id))[0]),M&&(a("#pData, #nData",A+"_2").css("float","right"),a(".EditButton",A+"_2").css("text-align","left")),b[s.p.id].topinfo&&a(".tinfo",y).show(),b[s.p.id].bottominfo&&a(".binfo",y).show(),X=null,U=null,a("#"+a.jgrid.jqID(B.themodal)).keydown(function(c){var
...
Z=p();o(Z[0],Z)}}})},viewGridRow:function(c,d){var
...
u="<a id='dData' class='fm-button "+h.button+"'>"+d.bSubmit+"</a>",v="<a id='eData' class='fm-button "+h.button+"'>"+d.bCancel+"</a>",w=a.isArray(b[e.p.id].buttons)?a.jgrid.buildButtons(b[e.p.id].buttons,u+v,h):u+v;if(t+="<table class='EditTable ui-common-table' id='"+o+"_2'><tbody><tr><td><hr class='"+h.content+"' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>"+w+"</td></tr></tbody></table>",d.gbox="#gbox_"+a.jgrid.jqID(l),a.jgrid.createModal(q,t,b[e.p.id],"#gview_"+a.jgrid.jqID(e.p.id),a("#gview_"+a.jgrid.jqID(e.p.id))[0]),a(".fm-button","#"+o+"_2").hover(function(){a(this).addClass(h.hover)},function(){a(this).removeClass(h.hover)}),d.delicon=a.extend([!0,"left",g.icon_del],b[e.p.id].delicon),d.cancelicon=a.extend([!0,"left",g.icon_cancel],b[e.p.id].cancelicon),!0===d.delicon[0]&&a("#dData","#"+o+"_2").addClass("right"===d.delicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='"+h.icon_base+" "+d.delicon[2]+"'></span>"),!0===d.cancelicon[0]&&a("#eData","#"+o+"_2").addClass("right"===d.cancelicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='"+h.icon_base+" "+d.cancelicon[2]+"'></span>"),a("#dData","#"+o+"_2").click(function(){var
...
c=a(this).val();return"default"===c?a("#"+f).jqFilter("addFilter",j):a("#"+f).jqFilter("addFilter",b.tmplFilters[parseInt(c,10)]),!1}),!0===b.multipleGroup&&(b.multipleSearch=!0),a(d).triggerHandler("jqGridFilterInitialize",[a("#"+f)]),a.isFunction(b.onInitializeSearch)&&b.onInitializeSearch.call(d,a("#"+f)),b.gbox="#gbox_"+f,b.layer?a.jgrid.createModal(i,m,b,"#gview_"+a.jgrid.jqID(d.p.id),a("#gbox_"+a.jgrid.jqID(d.p.id))[0],"string"==typeof
b.layer?"#"+a.jgrid.jqID(b.layer):b.layer,"string"==typeof
b.layer?{position:"relative"}:{}):a.jgrid.createModal(i,m,b,"#gview_"+a.jgrid.jqID(d.p.id),a("#gbox_"+a.jgrid.jqID(d.p.id))[0]),(b.searchOnEnter||b.closeOnEscape)&&a("#"+a.jgrid.jqID(i.themodal)).keydown(function(c){var
...
this.st&&"avg"===this.st.toLowerCase()&&(this.sd&&this.vd?this.v=this.v/this.vd:this.v&&m>0&&(this.v=this.v/m));try{this.groupCount=j.cnt,this.groupIndex=j.dataIndex,this.groupValue=j.value,h=k.formatter("",this.v,i,this)}catch(a){h=this.v}return o="<td "+k.formatCol(i,1,"")+">"+a.jgrid.template(p,h,j.cnt,j.dataIndex,j.displayValue)+"</td>",!1}}),n+=o}return n}var
...
0===d.exportcol&&(d.hidden?d.exportcol=!1:d.exportcol=!0),"cb"!==d.name&&"rn"!==d.name&&"subgrid"!==d.name||(d.exportcol=!1),d.exportcol&&(v.push(a.jgrid.formatCellCsv(o[c],b)),w.push(d.name))}),b.includeLabels&&(u=v.join(b.separator)+b.newLine),b.collen=v.length,j.p.grouping)q+=d(k,b);else
...
y=x[e].groupHeaders;for(p=0,g=[],i=0;i<w.length;i++){for(g[p]="",h=0;h<y.length;h++)y[h].startColumnName===w[i]&&(g[p]=a.jgrid.formatCellCsv(y[h].titleText,b));p++}s+=g.join(b.separator)+b.newLine}}if(b.includeFooter&&j.p.footerrow){if(a(".ui-jqgrid-ftable",this.sDiv).length){var
z=a(j).jqGrid("footerData","get");for(e=0,g=[];e<b.collen;){var
A=w[e];z.hasOwnProperty(A)&&g.push(a.jgrid.formatCellCsv(a.jgrid.stripHtml(z[A]),b)),e++}t+=g.join(b.separator)+b.newLine}}c=r+s+u+q+t}),b.returnAsString)return c;a.jgrid.saveAs(c,b.fileName,{type:b.mimetype})},exportToExcel:function(b){b=a.extend(!0,{includeLabels:!0,includeGroupHeader:!0,includeFooter:!0,fileName:"jqGridExport.xlsx",mimetype:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",maxlength:40,onBeforeExport:null,replaceStr:null},b||{}),this.each(function(){function
...
v;for(n=0,e=l.length;n<e;n++){for(g=0,p=[],v=l[n],f=0;f<m.length;f++)k={text:null==v[m[f]]?"":a.jgrid.formatCell(v[m[f]]+"",o[g],l[n],j[o[g]],h,"pdf"),alignment:r[m[f]],style:"tableBody"},p.push(k),g++;i.push(p)}}if(b.includeFooter&&h.p.footerrow){var
...
0===h[e].exportcol&&(h[e].exportcol=!0),!h[e].hidden&&"cb"!==h[e].name&&"rn"!==h[e].name&&h[e].exportcol&&(j.header[i]=h[e].name,j.width[i]=h[e].width,j.map[i]=e,j.align[i]=h[e].align||"left",i++);var
...
d,e="<tr>",f=0,g=a.length;f<g;f++)d=!0===c?" style=width:"+j.width[f]+"px;":"",e+="<"+b+d+">"+a[f]+"</"+b+">";return e+"</tr>"},o=function(b,c,d,e,f){for(var
i,k,l="<tr>",m=0,n=j.header.length;m<n&&(k=f?' colspan= "'+j.header.length+'" style=text-align:left':!0===e?" style=width:"+j.width[m]+"px;text-align:"+j.align[m]+";":" style=text-align:"+j.align[m]+";",i=j.header[m],b.hasOwnProperty(i)&&(l+="<"+c+k+">"+(d?a.jgrid.formatCell(b[i],j.map[m],b,h[j.map[m]],g,"html"):b[i])+"</"+c+">"),!f);m++);return l+"</tr>"},p='<table class="'+b.tableClass+'">';if(b.includeLabels&&(p+="<thead>"+n(j.header,"th",!0)+"</thead>"),p+="<tbody>",g.p.grouping)p+=d(j.body);else
for(var
...
q=window.open("","");q.document.close();var
r=b.title?"<title>"+b.title+"</title>":"";a("style, link").each(function(){r+=l(this)});try{q.document.head.innerHTML=r}catch(b){a(q.document.head).html(r)}q.document.body.innerHTML=(b.title?"<h1>"+b.title+"</h1>":"")+"<div>"+(b.topText||"")+"</div>"+p+"<div>"+(b.bottomText||"")+"</div>",a(q.document.body).addClass("html-view"),a("img",q.document.body).each(function(a,b){b.setAttribute("src",m(b.getAttribute("src")))}),b.onBeforeExport&&b.onBeforeExport(q),setTimeout(function(){b.autoPrint&&(q.print(),q.close())},1e3)}}),c}})});!function(a){"use strict";"function"==typeof
