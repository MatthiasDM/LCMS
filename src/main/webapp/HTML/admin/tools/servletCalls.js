...
function users_doLoad(_parent) {
    ...
    LCMSTableRequest("loadusers", "editusers", "./servlet", "user-table", "user-pager", "div-grid-user-wrapper", lang["users"]['title']);

}

function mongoconfigurations_doLoad(_parent) {
    console.log("Mongoconfigurations load");
    LCMSTableRequest("MONGOCONFIGURATIONS_LOADMONGOCONFIGURATIONS", "MONGOCONFIGURATIONS_EDITMONGOCONFIGURATIONS", "./admin", "mongoconfigurations-table", "mongoconfigurations-pager", "div-grid-user-wrapper", lang["mongoconfigurations"]['title']);
