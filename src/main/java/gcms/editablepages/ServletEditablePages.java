 ...
 * @author matmey
 */
@WebServlet(name = "EditablePagesServlet", urlPatterns = {"/editablepages/*", "/IT/editablepages"})
public class ServletEditablePages extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ActionManagerEditablePages aM = new ActionManagerEditablePages(requestParameters);
    ...
    class ActionManagerEditablePages {

        String cookie;
        gcms.Config.Actions action;
        HashMap<String, String[]> requestParameters = new HashMap<String, String[]>();

        public ActionManagerEditablePages(Map<String, String[]> requestParameters) {
        ...
        public StringBuilder startAction() throws ClassNotFoundException, IOException, JsonProcessingException, NoSuchFieldException {
            ...
            if (cookie != null) {
                ...
                if (action.toString().contains("EDIT")) {
                    ...
                    if (action.toString().contains("GET")) {
