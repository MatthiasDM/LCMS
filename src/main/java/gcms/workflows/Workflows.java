...
//            taskParameters.put("action", new String[]{gcms.Config.Actions.TASKS_EDITTASKS.name()});
...
//                Document doc;
//                doc = DatabaseActions.getObject(gcms.Config.MongoConf.ICTTICKETS, requestParameters.get("ticketid")[0]);
